...
export const navbarStyles = {
  ...
  logoGradient: "absolute -inset-3 rounded-full opacity-0 blur-xl group-hover:opacity-30 transition-opacity bg-gradient-to-r from-[#60A5FA] to-[#E0F2FE]",
  logoImage: "h-8 w-8 rounded-full z-10",
  logoText: "text-xl font-bold bg-gradient-to-r from-[#60A5FA] to-[#1E40AF] bg-clip-text text-transparent",
  logoUnderline: "h-0.5 w-0 bg-gradient-to-r from-[#60A5FA] to-[#E0F2FE] group-hover:w-full transition-all duration-500",
  ...
  loginGradient: "absolute -inset-2 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full opacity-0 blur-md group-hover:opacity-30 transition-opacity duration-500",
  loginIcon: "relative h-5 w-5 text-gray-600 group-hover:text-blue-600 transition-colors duration-300 z-10",
  ...
  mobileCartBadge:
    "absolute top-0 right-0 -mt-1 -mr-1 w-5 h-5 flex items-center justify-center text-[10px] font-bold text-white bg-gradient-to-r from-blue-500 to-blue-400 rounded-full",
...
export const container =
  "min-h-screen flex items-center justify-center px-4 pt-20 md:pt-29 pb-12 relative bg-[#E0F2FE]";
...
export const wordClass =
  "absolute text-2xl sm:text-3xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-[#1E40AF] to-[#60A5FA] transition-all duration-500";
...
export const searchButton =
  "px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-[#1E40AF] to-[#60A5FA] text-white rounded-lg md:rounded-xl font-medium hover:shadow-lg transition-all duration-300 shadow-md flex items-center gap-2 justify-center hover:-translate-y-0.5 text-sm md:text-base";
...
export const statNumber = "text-xl md:text-2xl font-bold text-[#1E40AF]";
...
export const imageWrapper =
  "relative w-full max-w-md lg:max-w-lg aspect-square bg-gradient-to-br from-white/20 to-[#E0F2FE]/10 rounded-xl md:rounded-2xl overflow-hidden";
...
export const overlayEffect =
  "absolute inset-0 mix-blend-overlay bg-gradient-to-t from-[#1E40AF]/10 to-transparent";
...
export const ourBestSellersStyles = {
  ...
  gradientText: "bg-gradient-to-r from-[#1E40AF] to-[#60A5FA] bg-clip-text text-transparent",
  ...
  qtyBtn: "text-[#1E40AF] hover:text-[#60A5FA] p-1 md:p-1.5",
  qtyText: "text-gray-900 font-medium w-6 text-center",

  addButton: "flex items-center gap-1.5 md:gap-2 px-4 md:px-6 py-2 md:py-3 bg-gradient-to-r from-[#1E40AF] to-[#60A5FA] text-white rounded-lg md:rounded-xl font-medium hover:scale-[1.02] transition-transform text-sm md:text-base",
...
export const homeBooksStyles = {
  section: "py-20 bg-gradient-to-br from-[#60A5FA] to-[#E0F2FE] relative",
  container: "container mx-auto px-4 md:px-6",
  card: "bg-white rounded-2xl shadow-lg p-8 md:p-12",
  heading: "text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#60A5FA] to-[#1D4ED8] bg-clip-text text-transparent mb-4",
  headingLine: "h-1 w-20 bg-gradient-to-r from-[#60A5FA] to-[#E0F2FE] rounded-full mx-auto",
  grid: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8",
  bookCard: "group relative",
  imageWrapper: "relative h-72 overflow-hidden rounded-xl border-4 border-[#60A5FA]/20 mb-4",
  ...
  discountPrice: "text-lg font-bold text-[#60A5FA]",
  originalPrice: "text-gray-400 line-through",
  actualPrice: "text-lg font-bold text-[#60A5FA]",
  qtyBox: "flex items-center justify-between bg-[#60A5FA]/10 px-4 py-2 rounded-lg",
  qtyBtn: "text-[#60A5FA] hover:text-[#1E40AF] cursor-pointer",
  addBtn:
    "w-full flex items-center cursor-pointer justify-center gap-2 px-4 py-2 bg-gradient-to-r from-[#60A5FA] to-[#E0F2FE] text-black rounded-lg hover:shadow-lg transition-all",
  viewBtnWrapper: "flex justify-center mt-12",
  viewBtn:
    "group inline-flex items-center justify-center px-6 py-3 rounded-full border-2 border-[#60A5FA] text-[#60A5FA] hover:bg-[#60A5FA]/10 transition-all",
...
export const homeAboutStyles = {
  ...
  bgBlur1: "absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-[#60A5FA]/20 blur-[100px]",
  bgBlur2: "absolute bottom-1/4 left-1/4 w-96 h-96 rounded-full bg-[#E0F2FE]/20 blur-[100px]",
  ...
  imageGlow: "absolute -inset-4 bg-gradient-to-r from-[#60A5FA] to-[#E0F2FE] rounded-2xl blur opacity-0 group-hover:opacity-20 transition-opacity duration-500",
  imageContainer: "relative overflow-hidden rounded-xl border-4 border-[#60A5FA]/20",
  aboutImage: "w-full h-auto rounded-xl transition-transform duration-700 hover:rotate-1",
  aboutHeader: "text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#60A5FA] to-[#1D4ED8] bg-clip-text text-transparent mb-4",
  underline: "h-1 w-20 bg-gradient-to-r from-[#60A5FA] to-[#E0F2FE] rounded-full",
  aboutText: "text-gray-600 leading-relaxed",
  statGrid: "grid grid-cols-1 md:grid-cols-3 gap-6",
  statCard: "bg-white border-2 border-[#60A5FA]/20 rounded-xl p-4 text-center shadow-lg",
  statIconWrap: "inline-flex items-center justify-center p-3 bg-[#E0F2FE] rounded-full mb-3",
  statIcon: "h-6 w-6 text-[#60A5FA]",
  statValue: "text-2xl font-bold text-gray-900",
  statLabel: "text-sm text-gray-600",
  aboutButton: "group inline-flex items-center justify-center px-6 py-3 rounded-full bg-gradient-to-r from-[#60A5FA] to-[#E0F2FE] text-black font-medium shadow-sm hover:shadow-[#60A5FA]/25 transition-all duration-300",
  arrowIcon: "ml-2 h-4 w-4 transition-transform group-hover:translate-x-1",
  sectionHeader: "text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#60A5FA] to-[#1D4ED8] bg-clip-text text-transparent mb-4",
  headerUnderline: "h-1 w-20 mx-auto bg-gradient-to-r from-[#60A5FA] to-[#E0F2FE] rounded-full",
  ...
  bookCardGlow: "absolute -inset-0.5 bg-gradient-to-r from-[#60A5FA] to-[#E0F2FE] rounded-xl blur opacity-0 group-hover:opacity-30 transition-opacity duration-500",
  bookCard: "relative bg-white border-2 border-[#60A5FA]/20 rounded-xl overflow-hidden transition-all duration-500 hover:shadow-lg hover:shadow-[#60A5FA]/20 h-full flex flex-col",
  ...
  bookAuthor: "text-sm text-[#60A5FA] mb-3",
  bookDesc: "text-gray-600 text-sm mb-4 flex-grow",
  discoverLink: "inline-flex items-center text-[#60A5FA] hover:text-[#1E40AF] transition-colors",
...
export const footerStyles = {
  footer: "bg-gray-100 border-t border-[#60A5FA]/20 pt-16 pb-8 relative",
  container: "container mx-auto px-4 md:px-6",
  ...
  logoText: "text-2xl font-bold bg-gradient-to-r from-[#60A5FA] to-[#1D4ED8] bg-clip-text text-transparent",
  aboutText: "text-gray-600 text-sm leading-relaxed",
  socialWrap: "flex gap-3",
  socialButton: "flex items-center justify-center w-9 h-9 rounded-full bg-white border border-[#60A5FA]/30 hover:border-[#60A5FA] hover:bg-[#E0F2FE]/20 transition-all duration-300",
  socialIcon: "h-4 w-4 text-[#60A5FA] transition-colors duration-300",
  quickLinksBlock: "space-y-4",
  quickLinksTitle: "text-lg font-semibold text-gray-900 mb-2",
  quickLinksList: "space-y-2.5",
  quickLinkItem: "group inline-flex items-center text-gray-600 hover:text-[#60A5FA] transition-colors duration-300 text-sm",
  quickLinkDot: "w-1.5 h-1.5 bg-[#60A5FA] rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200",
  ...
  formWrap: "relative",
  input: "w-full px-4 py-2.5 bg-white border border-[#60A5FA]/30 rounded-lg text-gray-600 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#60A5FA]/50 transition-all pr-12",
  button: "absolute right-1 top-1 p-2 bg-gradient-to-r from-[#60A5FA] to-[#E0F2FE] rounded-md text-white hover:scale-105 transform transition-all shadow-sm hover:shadow-[#60A5FA]/30",
  ...
  contactIcon: "h-4 w-4 text-[#60A5FA] mr-2 mt-1 flex-shrink-0",
  contactRow: "flex items-center text-gray-600 text-sm",
  contactIconInline: "h-4 w-4 text-[#60A5FA] mr-2 flex-shrink-0",
  copyrightWrap: "border-t border-[#60A5FA]/20 pt-6 text-center",
  copyrightText: "text-gray-500 text-sm",
}

//ContactUsPage
export const containerStyle = "min-h-screen pt-24 pb-16 bg-[#E0F2FE]"
...
export const inputStyle =
  "w-full pl-10 pr-4 py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#60A5FA] focus:border-[#60A5FA]"
export const textareaStyle =
  "w-full pl-10 pr-4 py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#60A5FA] focus:border-[#60A5FA]"
export const errorStyle = "text-red-500 text-sm mt-1"

export const submitButtonStyle =
  "w-full px-6 py-3 bg-[#60A5FA] text-white rounded-lg font-medium hover:bg-[#1E40AF] transition-colors disabled:opacity-70"
...
const aboutStyles = {
  container: "min-h-screen bg-[#E0F2FE] pt-24",
  ...
  heading: "text-6xl md:text-7xl font-black bg-gradient-to-r from-[#60A5FA] to-[#1D4ED8] bg-clip-text text-transparent mb-6 leading-tight",
  underline: "absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-48 h-2 bg-gradient-to-r from-[#60A5FA] to-[#E0F2FE] rounded-full",
  subText: "text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium",

  statsSection: "py-20 bg-gradient-to-br from-[#60A5FA]/5 via-[#E0F2FE]/5 to-[#60A5FA]/5",
  statCard: "bg-white/95 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-[#60A5FA]/10 transition-transform hover:-translate-y-2",
  statIconWrapper: "w-16 h-16 rounded-2xl bg-gradient-to-r from-[#60A5FA] to-[#E0F2FE] flex items-center justify-center mb-6 shadow-lg",
  statValue: "text-5xl font-black text-[#1D4ED8] mb-2",
  ...
  aboutOverlay: "absolute inset-0 bg-gradient-to-t from-[#60A5FA]/30 to-transparent",
  aboutCaption: "absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-[#1D4ED8]/80 to-transparent",
  ...
  aboutHeading: "text-5xl font-black bg-gradient-to-r from-[#60A5FA] to-[#1D4ED8] bg-clip-text text-transparent",
  aboutParagraph: "text-lg text-gray-700 leading-relaxed",
  aboutBoxGrid: "grid grid-cols-1 md:grid-cols-2 gap-6",
  aboutBox: "p-6 bg-white/95 backdrop-blur-lg rounded-2xl shadow-xl border border-[#60A5FA]/10",
  aboutBoxHeading: "text-2xl font-bold text-[#1D4ED8] mb-3",
  aboutBoxText: "text-gray-600",

  teamSection: "py-20 bg-gradient-to-br from-[#60A5FA]/5 to-[#E0F2FE]/5",
  sectionTitle: "text-5xl font-black bg-gradient-to-r from-[#60A5FA] to-[#1D4ED8] bg-clip-text text-transparent",
  sectionUnderline: "mt-6 h-1 w-24 mx-auto bg-gradient-to-r from-[#60A5FA] to-[#E0F2FE] rounded-full",
  teamCard: "group relative bg-white/95 backdrop-blur-lg rounded-[2rem] p-6 shadow-2xl border border-[#60A5FA]/10 transition-transform hover:-translate-y-3",
  ...
  teamOverlay: "absolute inset-0 bg-gradient-to-t from-[#60A5FA]/40 to-transparent",
  teamName: "text-2xl font-bold text-gray-900 mb-1",
  teamPosition: "text-lg text-[#60A5FA] font-medium mb-6",
  socialIcon: "p-2 rounded-full bg-gradient-to-r from-[#60A5FA] to-[#E0F2FE] text-white hover:shadow-lg transition-all hover:scale-110",

  branchSection: "py-20",
  branchCard: "bg-white/95 backdrop-blur-lg rounded-2xl p-6 shadow-2xl border border-[#60A5FA]/10 transition-transform hover:-translate-y-2",
  ...
  branchOverlay: "absolute inset-0 bg-gradient-to-t from-[#60A5FA]/30 to-transparent",
  branchInfoWrapper: "space-y-4",
  branchLocationWrapper: "flex items-center space-x-3",
  branchLocation: "text-xl font-semibold text-[#1D4ED8]",
...
export const booksPageStyles = {
  container: "min-h-screen pt-24 pb-16 bg-[#E0F2FE]",
  ...
  headerTitle: "text-4xl md:text-5xl font-bold text-transparent pb-2 md:pb-4 bg-clip-text bg-gradient-to-r from-[#1E40AF] to-[#60A5FA]",
  ...
  searchInput: "w-full pl-12 md:pl-16 pr-4 md:pr-6 py-3 md:py-4 bg-white/90 backdrop-blur-sm border-0 rounded-xl md:rounded-2xl shadow-md md:shadow-lg focus:ring-2 focus:ring-[#60A5FA]/30 text-base md:text-lg placeholder-gray-400 text-gray-700 transition-all",
  ...
  selectBox: "w-full md:w-auto px-4 md:px-5 py-2 md:py-3 bg-white/90 backdrop-blur-sm border-0 rounded-lg md:rounded-xl shadow-md md:shadow-lg text-gray-700 focus:ring-2 focus:ring-[#60A5FA]/30 text-sm md:text-base",
  ...
  price: "text-base md:text-lg font-bold text-[#1E40AF]",
  cartButtons: "flex cursor-pointer items-center gap-1 md:gap-2 px-3 md:px-4 py-2 md:py-2.5 bg-gradient-to-r from-[#1E40AF] to-[#60A5FA] text-white rounded-lg md:rounded-xl text-sm md:text-base font-medium hover:shadow-md hover:scale-[1.02] transition-all"
};



export const contactPageStyles = {
  containerStyle: "py-16 pt-24 bg-[#E0F2FE] min-h-screen relative",
  toastStyle: (type) =>
  ...
  inputStyle:
    "w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-[#60A5FA] focus:border-[#60A5FA] text-gray-700",
  errorStyle: "text-sm text-red-500 mt-1",
  textareaStyle:
    "w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-[#60A5FA] focus:border-[#60A5FA] text-gray-700 resize-none",
  submitButtonStyle:
    "w-full flex justify-center items-center bg-[#60A5FA] hover:bg-[#1E40AF] text-white font-semibold py-2 px-4 rounded-md shadow-md transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed",
  sendingStyle: "flex items-center",
  sendIconWrapperStyle: "flex items-center",
};

export const styles = {
  container: "min-h-screen bg-[#E0F2FE] pt-24 pb-12 px-4 sm:px-6 lg:px-8",
  ...
  checkoutBtn: "w-full flex items-center justify-center gap-2 px-5 py-3 md:px-6 md:py-4 bg-gradient-to-r from-[#1D4ED8] to-[#60A5FA] text-white rounded-lg md:rounded-xl font-semibold hover:opacity-90 transition-opacity text-sm md:text-base mb-3 md:mb-4",
...
export const Signup = {
  container: "min-h-screen flex items-center justify-center bg-[#E0F2FE] p-4",
  ...
  input: "w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#60A5FA] focus:border-[#60A5FA] text-gray-800 placeholder-gray-400",
  passwordInput: "w-full pl-10 pr-10 py-3 border rounded-lg focus:ring-2 focus:ring-[#60A5FA] focus:border-[#60A5FA] text-gray-800 placeholder-gray-400",
  togglePassword: "absolute right-3 top-3.5 text-gray-400",
  submitBtn: "w-full bg-[#60A5FA] text-white py-3 rounded-lg hover:bg-[#1E40AF] transition-colors",
...
export const loginStyles = {
  ...
  inputWrapper: "relative",
  input:
    "w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#60A5FA] focus:border-[#60A5FA] text-gray-800 placeholder-gray-500",
  passwordInput:
    "w-full pl-10 pr-10 py-3 border rounded-lg focus:ring-2 focus:ring-[#60A5FA] focus:border-[#60A5FA] text-gray-800 placeholder-gray-500",
  togglePassword: "absolute right-3 top-3.5 text-gray-400",
  submitButton:
    "w-full bg-[#60A5FA] text-white py-3 rounded-lg hover:bg-[#1E40AF] transition-colors disabled:opacity-70",
  footerText: "mt-6 text-center text-gray-600",
  footerLink: "text-[#60A5FA] hover:underline",
  ...
  homepageButton:
    "w-full bg-[#60A5FA] text-white py-3 rounded-lg hover:bg-[#1E40AF] transition-colors mb-2",
  signOutButton:
